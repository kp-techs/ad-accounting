...
function Table({ filters }: Props) {
	...
	return (
		<Wrapper>
			<DeleteModal isOpen={isDeleteModalOpen} onClose={toggleDeleteModal} income={activeIncome} />
			<IncomesModal isOpen={isModifyModalOpen} onClose={toggleModifyModal} income={activeIncome} />
			<DetailsModal isOpen={isDetailsModalOpen} onClose={toggleDetailsModal} income={activeIncome} />
			{incomes.count ? (
