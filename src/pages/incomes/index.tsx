		...
		<Wrapper>
			<nav>
				{(activeAction === "ADD" || !activeAction) && (
					<div
						onClick={() => {
							activeAction === "ADD" ? setActiveAction(undefined) : setActiveAction("ADD");
						}}
				...
				{(activeAction === "FILTER" || !activeAction) && (
					<div
						onClick={() => {
							activeAction === "FILTER" ? setActiveAction(undefined) : setActiveAction("FILTER");
						}}
						className={"button nav-button"}
					>
						<FaFilter size={20} />
			...
			<IncomesModal isOpen={activeAction === "ADD"} onClose={() => setActiveAction(undefined)} />
			<FilterSection
